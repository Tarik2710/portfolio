      ...
      <MotionAnimate
        ...
        <div className="w-full min-h-screen flex flex-col md:flex-row items-center justify-center bg-[#181818] relative overflow-hidden shadow-md border-b-4 border-[#4b4f58]">
          ...
          <div className="md:w-1/2 xl:p-8 lg:p-8 md:p-8 sm:p-4 text-[#f5f3f4] font-medium text-center relative z-20  ">
            ...
            <a href={Pdf} without rel="noopener noreferrer" target="_blank"><button trailingIcon="picture_as_pdf" label="Resume" className="bg-[#ffffff] hover:bg-[radial-gradient(ellipse_at_left,_var(--tw-gradient-stops))] from-sky-400 to-blue-800 transition duration-700 ease-in-out hover:scale-110  text-black uppercase font-black py-2 px-4 rounded shadow-lg hover:shadow-2xl sm:mb-16 sm:mt-10 lg:mt-5">
              See My CV
            </button></a>
