    ...
    <div className='w-full min-h-screen flex justify-center'> 
        ...
        <form method='POST' action="https://getform.io/f/4ec4b650-7aa1-474c-969c-a66d556454d2" className='flex flex-col max-w-[600px] w-full'>
            <div className='pb-8 '>
                ...
                <p className='text-[#ffff] py-4 flex items-center text-xl sm:ml-7'> <FontAwesomeIcon icon="fa-solid fa-envelope" className="text-4xl flex mr-3 font-semibold"/> <button onClick={() => window.location = 'mailto:tarik.bijedic@yahoo.com'}>tarik.bijedic@yahoo.com</button></p>
                <p className='text-[#ffff] py-2 text-xl items-center flex  sm:ml-7'> <FontAwesomeIcon icon="fa-solid fa-phone" className="text-4xl mr-3  py-2 font-semibold"/>065/646-550</p>
            ...
            <button className='bg-[conic-gradient(at_top_left,_var(--tw-gradient-stops))] from-rose-100 to-teal-100 hover:bg-gradient-to-tr text-black uppercase font-black py-2 px-4 my-8 mx-auto flex items-center'>SUBMIT</button>
        </form>
    </div>
        </MotionAnimate>
