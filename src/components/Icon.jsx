...
const Icon = () => {
    ...
    return  (
    <div className="list-none  flex sm:justify-center lg:justify-start ">
        <a href="https://github.com/Tarik2710" target="_blank"  rel="noreferrer" aria-label="GitHub link"  className="text-gray-500 hover:text-gray-900 dark:hover:text-white dark:text-gray-400 list-none">
